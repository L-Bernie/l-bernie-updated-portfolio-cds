...
declare const CDSContentSwitcherItem_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
export default class CDSContentSwitcherItem extends CDSContentSwitcherItem_base {
    /**
...
//# sourceMappingURL=content-switcher-item.d.ts.map
