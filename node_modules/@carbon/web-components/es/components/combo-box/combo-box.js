  ...
  return {
    ...
    d: [{
      ...
      <input
        ...
        ?readonly=${0}
        @input=${0} />
    `), inputClasses, disabled, label, filterInputValue, ifNonEmpty(inputLabel), String(open), ifDefined(open ? activeDescendant !== null && activeDescendant !== void 0 ? activeDescendant : activeDescendantFallback : ''), readOnly, handleInput);
      }
    }, {
      kind: "method",
