...
import '../button/index';
declare const CDSPagination_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class CDSPagination extends CDSPagination_base {
     ...
     */
    private _handleUserInitiatedChangeStart;
    /**
