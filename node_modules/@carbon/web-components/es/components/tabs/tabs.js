  ...
  return {
    ...
    d: [{
      ...
      value: function _handleClick(event) {
        _superPropGet(CDSTabs, "_handleClick", this, 3)([event]);
      }
    }, {
      kind: "method",
      ...
      value: function _selectionDidChange(itemToSelect) {
        _superPropGet(CDSTabs, "_selectionDidChange", this, 3)([itemToSelect]);
      ...
      value: function disconnectedCallback() {
        ...
        _superPropGet(CDSTabs, "disconnectedCallback", this, 3)([]);
      }
    }, {
      kind: "method",
      key: "shouldUpdate",
      value: function shouldUpdate(changedProperties) {
        _superPropGet(CDSTabs, "shouldUpdate", this, 3)([changedProperties]);
        if (this.tablist) {
          const {
            clientWidth,
            scrollWidth
