...
declare const CDSSideNavMenu_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class CDSSideNavMenu extends CDSSideNavMenu_base {
    /**
     ...
     */
    private _titleIconContainerNode;
    /**
     ...
     */
    private _handleSlotChangeTitleIcon;
    /**
     ...
     */
    static attribItemHasIcon: string;
    /**
...
//# sourceMappingURL=side-nav-menu.d.ts.map
