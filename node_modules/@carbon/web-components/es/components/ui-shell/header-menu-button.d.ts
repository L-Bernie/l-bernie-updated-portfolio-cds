...
declare const CDSHeaderMenuButton_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class CDSHeaderMenuButton extends CDSHeaderMenuButton_base {
     ...
     */
    collapseMode: SIDE_NAV_COLLAPSE_MODE;
    /**
...
//# sourceMappingURL=header-menu-button.d.ts.map
