  ...
  return {
    ...
    d: [{
      ...
      function render() {
        ...
        if (optionalClasses) {
          const outputObject = {};
          optionalClasses === null || optionalClasses === void 0 || optionalClasses.split(' ').forEach(element => {
        ...
        if (paragraph) {
          ...
          for (let i = 0; i < lineCount; i++) {
            ...
            lines.push(html(_t || (_t = _`<p class="${0}" style="${0}"></p>`), classes, style));
          }
          return lines;
        }
        return html(_t2 || (_t2 = _`<p class="${0}" style="width:${0}"></p>`), classes, width);
      }
    }, {
      kind: "field",
      static: true,
