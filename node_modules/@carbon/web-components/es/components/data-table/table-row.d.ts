...
declare const CDSTableRow_base: {
    new (...args: any[]): {
...
declare class CDSTableRow extends CDSTableRow_base {
     ...
     */
    private _handleClickSelectionRadio;
    /**
     * Handles `click` event on the check box.
     *
     * @param event The event.
     */
    private _handleClickSelectionCheckbox;
    /**
     ...
     */
    protected _renderFirstCells(): import("lit-html").TemplateResult<1> | undefined;
    /**
     ...
     * The name of the custom event fired after this radio button changes its checked state.
     */
    static get eventCheckboxChange(): string;
    /**
