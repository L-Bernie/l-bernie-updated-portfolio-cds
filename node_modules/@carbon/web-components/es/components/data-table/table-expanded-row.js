  ...
  return {
    ...
    `), colSpan, prefix);
      ...
      value: function updated() {
        ...
        (_this$previousElement = this.previousElementSibling) !== null && _this$previousElement !== void 0 && _this$previousElement.hasAttribute('slug') ? this.setAttribute('slug', '') : this.removeAttribute('slug');
      }
