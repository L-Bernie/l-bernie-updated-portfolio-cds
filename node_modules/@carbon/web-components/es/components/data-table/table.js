  ...
  return {
    ...
    d: [{
      ...
      function connectedCallback() {
        ...
        _superPropGet(CDSTable, "connectedCallback", this, 3)([]);
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      ...
      value: function updated(changedProperties) {
        ...
        this._tableRows.forEach(row => {
          Array.prototype.slice.call(row.children).forEach((cell, index) => {
            headersWithSlug.includes(index) ? cell.setAttribute('slug-in-header', '') : cell.removeAttribute('slug-in-header');
          });
        });
      }
