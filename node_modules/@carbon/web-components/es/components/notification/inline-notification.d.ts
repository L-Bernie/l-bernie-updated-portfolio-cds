...
declare const CDSInlineNotification_base: {
    new (...args: any[]): {
        focus(): void;
        accessKey: string;
 ...
 */
declare class CDSInlineNotification extends CDSInlineNotification_base {
    /**
     ...
     */
    protected _cancelTimeout(timeoutID: number): void;
    /**
     * Overrides (if exists) the timeout to close the notification
     *
     * @param timeout the time in ms
     */
    protected _initializeTimeout(timeout: number): void;
    /**
     ...
     */
    protected _handleClickCloseButton({ target }: MouseEvent): void;
    /**
     ...
     */
    protected _handleUserOrTimerInitiatedClose(triggeredBy: EventTarget | null): void;
    /**
...
//# sourceMappingURL=inline-notification.d.ts.map
