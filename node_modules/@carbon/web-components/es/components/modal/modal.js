  ...
  return {
    ...
    d: [{
      ...
      value: function _handleSlotChange() {
        this.querySelector(`${prefix}-modal-footer`) ? this.setAttribute('has-footer', '') : this.removeAttribute('has-footer');
      }
      ...
      <a
        ...
        href="javascript:void 0"
        role="navigation"></a>
    `), prefix, ariaLabel, containerClasses, alert ? 'alert' : 'dialog', this._handleClickContainer, this._handleSlotChange, hasScrollingContent ? html(_t2 || (_t2 = _` <div class="cds--modal-content--overflow-indicator"></div> `)) : ``, prefix);
      }
    }, {
      kind: "method",
      key: "updated",
