...
let CDSDropdown = _decorate([customElement(`${prefix}-dropdown`)], function (_initialize, _ValidityMixin) {
  ...
  return {
    ...
    `), labelClasses, !hasTitleText, handleSlotchangeLabelText, titleText);
      ...
      value: function render() {
        ...
        if (open && !activeDescendant) {
          ...
          const constructor = this.constructor;
          const items = this.querySelectorAll(constructor.selectorItem);
          activeDescendantFallback = (_items$ = items[0]) === null || _items$ === void 0 ? void 0 : _items$.id;
        }
    ...
    `), ifDefined(ariaLabel ? undefined : 'dropdown-label'), ifDefined(ariaLabel ? ariaLabel : undefined), prefix, !open);
    ...
    `), this._renderTitleLabel(), classes, invalid, handleClickInner, handleKeydownInner, handleKeypressInner, ifDefined(!shouldTriggerBeFocusable ? undefined : 'trigger-button'), prefix, ifDefined(!shouldTriggerBeFocusable ? undefined : '0'), ifDefined(!shouldTriggerBeFocusable ? undefined : 'combobox'), ifDefined(!shouldTriggerBeFocusable ? undefined : 'dropdown-label'), ifDefined(!shouldTriggerBeFocusable ? undefined : String(open)), ifDefined(!shouldTriggerBeFocusable ? undefined : 'listbox'), ifDefined(!shouldTriggerBeFocusable ? undefined : 'menu-body'), ifDefined(!shouldTriggerBeFocusable ? undefined : open ? activeDescendant !== null && activeDescendant !== void 0 ? activeDescendant : activeDescendantFallback : ''), this._renderPrecedingLabel(), this._renderLabel(), validityIcon, warningIcon, this._renderFollowingLabel(), iconContainerClasses, ChevronDown16({
          'aria-label': toggleLabel
        }), handleSlugSlotChange, menuBody, helperClasses, inline && !warn && !invalid || !hasHelperText, handleSlotchangeHelperText, helperMessage);
      }
