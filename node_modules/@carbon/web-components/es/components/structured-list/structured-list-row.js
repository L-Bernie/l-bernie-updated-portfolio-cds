  ...
  return {
    ...
    d: [{
      ...
      function connectedCallback() {
        ...
        _superPropGet(CDSStructuredListRow, "connectedCallback", this, 3)([]);
        if (!this._manager) {
      ...
      value: function disconnectedCallback() {
        ...
        _superPropGet(CDSStructuredListRow, "disconnectedCallback", this, 3)([]);
      }
    }, {
      kind: "method",
      key: "updated",
      ...
      `), prefix, prefix, selected, selectionName, ifDefined(selectionValue), prefix, prefix, CheckmarkFilled16({
