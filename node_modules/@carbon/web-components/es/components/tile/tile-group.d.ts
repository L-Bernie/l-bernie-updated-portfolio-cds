...
declare const CDSTileGroup_base: {
    new (...args: any[]): {
 ...
 */
declare class CDSTileGroup extends CDSTileGroup_base {
    private _handleRadioClick;
    private _handleSelectableClick;
    /**
     * Click listener to ensure selectability.
     *
     * @param event click
     */
    private _handleTileSelect;
    /**
     * Handle keyboard navigation for radio tiles
     *
     * @param nextSibling to focus on
     */
    private _handleKeydownRadio;
    /**
     ...
     * @param nextSibling to focus on
     */
    private _handleKeydownSelectable;
    /**
     ...
     */
    static get selectorRadioTile(): string;
    /**
     * A selector that selects a selectable tile component.
     */
    static get selectorSelectableTile(): string;
    /**
     * The name of the custom event fired after a radio tile changes its selected state.
     */
    static get eventCurrentRadioTileSelection(): string;
    /**
     * The name of the custom event fired after a radio tile changes its selected state.
     */
    static get eventCurrentSelectableTilesSelection(): string;
    static styles: any;
}
export default CDSTileGroup;

//# sourceMappingURL=tile-group.d.ts.map
