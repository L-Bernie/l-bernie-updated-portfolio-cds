...
var descriptor = (exports.descriptor = {
  onBeforeToggle: {
    event: ''.concat(_settings.prefix, '-expandable-tile-beingtoggled'),
  },
  onToggle: {
    event: ''.concat(_settings.prefix, '-expandable-tile-toggled'),
  },
});
...
const Component = (0, _createReactCustomElementType.default)(
  ''.concat(_settings.prefix, '-expandable-tile'),
  descriptor
);
