...
var descriptor = (exports.descriptor = {
  onBeforeSelect: {
    event: ''.concat(_settings.prefix, '-content-switcher-beingselected'),
  },
  onSelect: {
    event: ''.concat(_settings.prefix, '-content-switcher-selected'),
  },
});
...
const Component = (0, _createReactCustomElementType.default)(
  ''.concat(_settings.prefix, '-content-switcher'),
  descriptor
);
