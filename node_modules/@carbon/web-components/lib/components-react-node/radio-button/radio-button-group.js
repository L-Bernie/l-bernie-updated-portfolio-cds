...
Object.defineProperty(exports, 'RADIO_BUTTON_ORIENTATION', {
  enumerable: true,
  get: function () {
    return _defs.RADIO_BUTTON_ORIENTATION;
  },
});
...
var descriptor = (exports.descriptor = {
  onChange: {
    event: ''.concat(_settings.prefix, '-radio-button-group-changed'),
  },
  onChangeRadioButton: {
...
var propTypes = (exports.propTypes = {
  ...
  onChangeRadioButton: _propTypes.default.func,
});
const Component = (0, _createReactCustomElementType.default)(
  ''.concat(_settings.prefix, '-radio-button-group'),
  descriptor
);
