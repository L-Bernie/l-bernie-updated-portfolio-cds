...
var descriptor = (exports.descriptor = Object.assign({}, _search.descriptor, {
  onInput: {
    event: ''.concat(_settings.prefix, '-search-input'),
  },
}));
var propTypes = (exports.propTypes = Object.assign({}, _search.propTypes, {
  onInput: _propTypes.default.func,
}));
const Component = (0, _createReactCustomElementType.default)(
  ''.concat(_settings.prefix, '-table-toolbar-search'),
  descriptor
);
