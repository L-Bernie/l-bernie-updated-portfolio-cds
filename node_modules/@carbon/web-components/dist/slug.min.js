 ...
 * LICENSE file in the root directory of this source tree.
 */
let h,u;!function(o){o.MINI="mini",o.EXTRA_EXTRA_SMALL="2xs",o.EXTRA_SMALL="xs",o.SMALL="sm",o.MEDIUM="md",o.LARGE="lg",o.EXTRA_LARGE="xl"}(h||(h={})),function(o){o.DEFAULT="",o.INLINE="inline"}(u||(u={}));let b,f,m,y,_,C,x=o=>o;e([l(`${p}-slug`)],(function(o,e){class a extends e{constructor(...t){super(...t),o(this)}}return{F:a,d:[{kind:"field",decorators:[n({reflect:!0})],key:"slot",value:()=>"slug"},{kind:"field",decorators:[n({attribute:"ai-text"})],key:"aiText",value:()=>"AI"},{kind:"field",decorators:[n({attribute:"ai-text-label"})],key:"aiTextLabel",value:()=>""},{kind:"field",decorators:[n({reflect:!0})],key:"kind",value:()=>u.DEFAULT},{kind:"field",decorators:[n({type:Boolean,attribute:"revert-active"})],key:"revertActive",value:()=>!1},{kind:"field",decorators:[n({attribute:"revert-label"})],key:"revertLabel",value:()=>"Revert to AI input"},{kind:"field",decorators:[n({reflect:!0})],key:"size",value:()=>h.EXTRA_SMALL},{kind:"field",decorators:[n({attribute:"slug-label"})],key:"slugLabel",value:()=>"Show information"},{kind:"field",decorators:[n()],key:"previousValue",value:void 0},{kind:"field",key:"_handleClick",value(){return()=>{this.revertActive?(this.revertActive=!1,this.removeAttribute("revert-active")):this.open=!this.open}}},{kind:"field",key:"_renderToggleTipLabel",value:()=>()=>s(b||(b=x``))},{kind:"field",key:"_renderTooltipButton",value(){return()=>{const{size:o,kind:t,aiText:e,aiTextLabel:r,slugLabel:c}=this,n=`${e} - ${c}`,a=d({[`${p}--toggletip-button`]:!0,[`${p}--slug__button`]:!0,[`${p}--slug__button--${o}`]:o,[`${p}--slug__button--${t}`]:t,[`${p}--slug__button--inline-with-content`]:t===u.INLINE&&r});return s(f||(f=x`
      <button
        aria-controls="${0}"
        @click="${0}"
        class=${0}
    ...
    `),this.id,this._handleClick,a,n,p,e,r&&t===u.INLINE?s(m||(m=x`
              <span class="${0}--slug__additional-text">
                ${0}
              </span>
            `),p,r):"")}}},{kind:"field",key:"_renderInnerContent",value(){return()=>{const{autoalign:o,revertActive:e,revertLabel:p}=this;return s(y||(y=x`
      ${0}
    `),e?s(_||(_=x`
            <cds-icon-button
              ?autoalign=${0}
          ...
          `),o,this._handleClick,p,(({children:o,...e}={})=>t`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${i(e)}" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16">${o}<path d="M12,8c1.2,0,2,0.8,2,2c0,1.2-0.8,2-2,2H9v1h3c1.7,0,3-1.2,3-3c0-1.7-1.3-3-3-3L2.9,7l2-2L4.2,4.3L1,7.5	l3.2,3.2L4.9,10l-2-2L12,8z"></path></svg>`)({slot:"icon"})):s(C||(C=x`
            ${0} ${0}
          `),this._renderTooltipButton(),this._renderTooltipContent()))}}},{kind:"method",key:"attributeChangedCallback",value:function(o,t,e){var s;!function(o,t,e,s){var p=r(c(1&s?o.prototype:o),t,e);return 2&s?function(o){return p.apply(e,o)}:p}(a,"attributeChangedCallback",this,3)([o,t,e]),"revert-active"===o&&(null===(s=this.parentElement)||void 0===s||s.requestUpdate())}},{kind:"field",static:!0,key:"styles",value:()=>g}]}}),a),e([l(`${p}-slug-action-button`)],(function(o,t){return{F:class extends t{constructor(...t){super(...t),o(this)}},d:[{kind:"field",decorators:[n({reflect:!0})],key:"slot",value:()=>"actions"},{kind:"field",static:!0,key:"styles",value:()=>g}]}}),v);
